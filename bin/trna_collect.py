...
parser.add_argument("--trna_dir", help="directory containing processed tRNA files", type=str, default=".")
...
tsv_files = [f for f in os.listdir(args.trna_dir) if f.endswith('_processed_trnas.tsv')]
